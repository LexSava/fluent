...
2. После каждого ответа сначала напиши объяснение на русском, затем с новой строки JSON с оценкой:
   \`\`\`json
   {"score": 8, "correct": true, "feedback": "Отлично! Правильно использована форма прошедшего времени.", "vocabTerm": "слово из списка или null"}
   \`\`\`
   JSON ВСЕГДА пишется в самом конце сообщения. Никогда не пиши JSON в начале или середине.
3. После JSON блока сразу давай следующее упражнение в том же сообщении.
